//Daniel Huang(Main) + Hridhoy Ahmond(Contributor)
...
public class SaltVerifier {
    ...
    public static void main(String[] args) {
        ...
        read(UID, "D://Dropbox/Education/College/Projects/Password/Password.txt", "Password: ");//reads password file
        password = line;
        read(UID, "D://Dropbox/Education/College/Projects/Password/Salt.txt", "Salt value: ");//reads salt file
        salt = line;
        Con(password, salt);
        ...
        Check2("D://Dropbox/Education/College/Projects/Password/Hash.txt", UID, hashtext);
